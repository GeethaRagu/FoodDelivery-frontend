  ...
  return (
    <div className="grid sm:grid-cols-2 grid-cols-1">
      <Formik>
        <Form onSubmit={formik.handleSubmit}>
          <div>
            ...
            <div className="grid grid-cols-2 pb-2">
              <label className="label p-2">
                <span className="text-base label-text text-black">Street</span>
              </label>
              <Field
                type="text"
                name="street"
            ...
            <div className="grid grid-cols-2 pb-2">
              <label className="label p-2">
                <span className="text-base label-text text-black">Country</span>
              </label>
              <Field
                type="text"
                name="country"
            ...
            <div className="grid grid-cols-2 pb-2">
              <label className="label p-2">
                <span className="text-base label-text text-black">Zipcode</span>
              </label>
              <Field
                type="text"
                name="zipcode"
      ...
      <div className="pl-5 pr-5">
        ...
        <button className="text-white bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:focus:ring-yellow-900 mt-10">
          Proceed to Payment
        </button>
      </div>
    </div>
