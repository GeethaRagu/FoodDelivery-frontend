          ...
          return (
            <div key={index} onClick={()=>setCategory(prev=>prev===element.menu_name?"All":element.menu_name)}>
              <img
                ...
                alt=""
                className={`min-w-20 cursor-pointer transition-discrete ${category===element.menu_name?"rounded-full border-3 border-amber-700 flex justify-center items-center p-1":""}`}
